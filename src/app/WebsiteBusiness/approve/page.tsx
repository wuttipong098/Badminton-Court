  ...
  return (
    <div className="min-h-screen flex flex-col">
                  ...
                  {openDropdown === member.RegisterID && (
                    <div className={styles.dropdownContent}>
                      ...
                      <div className={styles.images}>
                        <p>รูปภาพของ {member.StadiumName}</p>
                        {member.Image && member.Image.length > 0 ? (
                          <div className="flex flex-wrap gap-4">
                            {member.Image.map((img, index) => (
                              <div
                                key={index}
                              ...
                              >
                                <Image
                                  src={img}
                                  alt={`Image ${index + 1} for ${member.StadiumName}`}
                                  width={200}
                                  height={200}
      ...
      {selectedImage && (
        ...
        >
          <div
            className="relative bg-white p-4 rounded-lg shadow-lg border border-gray-300 max-w-2xl w-full"
          ...
          >
            ...
            />
            <button
              className="absolute bottom-4 left-4 bg-red-600 text-white px-3 py-2 rounded hover:bg-red-700"
              onClick={closeImageModal}
            >
              ×
            </button>
